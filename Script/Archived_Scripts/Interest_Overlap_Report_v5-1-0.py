                    ...
                    if fc == listItems[0]:
                        ...
                        for row in arcpy.da.SearchCursor(fc, [field.name for field in fields]):
                            for item in row:                                
                                ...
                                elif isinstance(item, datetime.datetime) == True:
                                    if item < datetime.datetime.strptime('01 01 1900', '%m %d %Y'):
                                        sheetCells(sheet, excelrow, excelcol, str(item), 8, False, False, False, None)
                                    else:
                                        sheetCells(sheet, excelrow, excelcol, item, 8, False, False, False, None)                                         
...
#             arcpy.AddMessage(grouprow)
#             arcpy.AddMessage(excelrow)
#             arcpy.AddMessage(str(grouprow) + ":" + str(excelrow))
#             sheet.Rows("10:25").Group
