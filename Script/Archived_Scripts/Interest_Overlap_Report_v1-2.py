...
#        if row.getValue('Featureclass_Name') == district:
...
if ntpath.basename(clip_feature) not in [r'MTA_SPATIAL.MTA_ACQUIRED_TENURE_SVW', r'MTA_SPATIAL.MTA_SITE_SVW']:
    ...
    excelcol += 3
    sheet.Cells(staticexcelrow - 1,excelcol).Value = "Area of Interest Information"
    sheet.Cells(staticexcelrow - 1,excelcol).Font.Bold = True    
...
# next conditional sentence is to determine of the user chose the tenure feature class
    ...
    excelcol += 3
    sheet.Cells(staticexcelrow - 1,excelcol).Value = "Tenure Information"
    sheet.Cells(staticexcelrow - 1,excelcol).Font.Bold = True    
...
# Last conditional sentence is to determine of the user chose the reserves feature class
    ...
    arcpy.AddMessage(ntpath.basename(clip_feature))
    excelcol += 3
    sheet.Cells(staticexcelrow - 1,excelcol).Value = "Reserve Information"
    sheet.Cells(staticexcelrow - 1,excelcol).Font.Bold = True
...
for row in arcpy.SearchCursor(xls):  
    ...
    if str(row.getValue("Category")) <> 'District':
