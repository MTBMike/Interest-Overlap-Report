...
mapRequest = arcpy.GetParameter(7)
orientation = arcpy.GetParameterAsText(8)
mapTitle = arcpy.GetParameterAsText(9)
mapSubtitle = arcpy.GetParameterAsText(10)
...
clippedGDB = "IOR_Clipped_FeatureClasses_" + strftime('%d%b%Y') + ".gdb"
