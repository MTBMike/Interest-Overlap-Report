...
## Keep thses parameters for testing purposes
#     # Input Parameters
            ...
            if selectcount <> 0:
                ...
                if desc.shapeType == "Polygon":
                    ...
                    if row[0] in layerListDict:
                        layerListDict[row[0]].update({row[1]: [str(outFC + "_clip"), str(row[19])]})
                    else:
                    ...
                    if row[0] in layerListDict:
                        ...
                        layerListDict[row[0]] = {}
                        layerListDict[row[0]].update({row[1]: [str(outFC + "_clip"), str(row[19])]})
                        layerListDict[row[0]].update({row[1]: [str(row[1] + "_clip"), str(row[19])]})                
                ...
                if row[0] in layerListDict:
                    layerListDict[row[0]].update({row[1]: ["No Overlap Found", str(row[19])]})
                else:
                    # create a new array in this slot
                    layerListDict[row[0]] = {}
                    layerListDict[row[0]].update({row[1]: ["No Overlap Found", str(row[19])]})
