...
if mapRequest == True:
    ...
    if orientation == 'Landscape':
        ...
        mxd = arcpy.mapping.MapDocument(r"\\spatialfiles.bcgov\Work\em\vic\mtb\Local\mxd_templates\2014_Templates\Template_(8.5x11Landscape)_26Jun14.mxd")
        titlex = 24.7749
        titley = 17.7057
        subtitlex = 24.7749
        subtitley = 16.8424
        ...
        arcpy.AddMessage(orientation)
        mxd = arcpy.mapping.MapDocument(r"\\spatialfiles.bcgov\Work\em\vic\mtb\Local\mxd_templates\2014_Templates\Template_(8.5x11Portrait)_26Jun14.mxd")
        titlex = 3.2244
        titley = 2.0283
        subtitlex = 3.2244
        subtitley = 1.2077
